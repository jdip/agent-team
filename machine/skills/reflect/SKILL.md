...
- **Missing capability:** identify the smallest practical code constraint, native
  check or helper that prevents recurrence. Prefer structural prevention when it
  earns its maintenance cost; otherwise improve the relevant guidance or skill.
